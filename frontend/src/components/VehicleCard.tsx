...
interface Props {
  vehicle: Vehicle;
  /**
   * true fuer die ersten sichtbaren Karten (Above-the-fold): das Bild wird
   * eager statt lazy geladen, damit es nicht erst beim Scroll-Trigger des
   * Browsers nachgeladen wird. Fuer alle anderen Karten bleibt loading="lazy"
   * aktiv, um Bandbreite/Ladezeit fuer nicht sofort sichtbare Bilder zu sparen.
   */
  priority?: boolean;
}
